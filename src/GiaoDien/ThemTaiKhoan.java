...
public class ThemTaiKhoan extends javax.swing.JFrame {
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        // TODO add your handling code here:
            if (idSave >= 0) {
                ...
                if (AccountDAO.getInstance().isUsernameExistsForUpdate(idSave, txtUsername.getText())) {
                    JOptionPane.showMessageDialog(null, "Tên tài khoản đã tồn tại! Vui lòng nhập tên tài khoản khác.");
                    return;
                }

                // Thực hiện cập nhật tài khoản nếu không trùng
                if (AccountDAO.getInstance().Update(idSave, txtName.getText(), txtUsername.getText(), txtPass.getText())) {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        // Kiểm tra trùng tên tài khoản
        if (AccountDAO.getInstance().isUsernameExists(txtUsername.getText())) {
            JOptionPane.showMessageDialog(null, "Tên tài khoản đã tồn tại! Vui lòng nhập tên tài khoản khác.");
            return;
        }

        // Thêm tài khoản nếu không trùng tên
...
//                txtUsername.disable();
    ...
    private void btnHomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHomeActionPerformed
        // TODO add your handling code here:
        MenuDangNhap menu = new MenuDangNhap();
